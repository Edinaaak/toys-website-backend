    ...
    public partial class Inita : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_celine", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    slikarId = table.Column<int>(type: "int", nullable: false),
                    celinaId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_umetnickaDela_sale_salaId",
                        column: x => x.salaId,
                        principalTable: "sale",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_userDelo", x => new { x.UserId, x.DeloId });
                    table.ForeignKey(
                        name: "FK_userDelo_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_userDelo_umetnickaDela_DeloId",
                        column: x => x.DeloId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_sale_MestoId",
                table: "sale",
                column: "MestoId");

            migrationBuilder.CreateIndex(
                name: "IX_umetnickaDela_celinaId",
                table: "umetnickaDela",
                column: "celinaId");

            migrationBuilder.CreateIndex(
                name: "IX_umetnickaDela_salaId",
                table: "umetnickaDela",
                column: "salaId");

            migrationBuilder.CreateIndex(
                name: "IX_umetnickaDela_slikarId",
                table: "umetnickaDela",
                column: "slikarId");

            migrationBuilder.CreateIndex(
                name: "IX_userDelo_DeloId",
                table: "userDelo",
                column: "DeloId");
        }
